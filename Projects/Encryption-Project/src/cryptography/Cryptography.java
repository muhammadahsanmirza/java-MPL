...
public class Cryptography extends JFrame implements ActionListener {
    ...
    public Cryptography() {
        ...
        browse.setForeground(Color.decode("#009999"));
        ...
        denc.setBackground(Color.white);
        ...
        JLabel j = new JLabel("Swift Decode");
        j.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 60)); // Set font style to bold and italic, and increase size
        j.setHorizontalAlignment(JLabel.CENTER);
        j.setVerticalAlignment(JLabel.CENTER);
        j.setForeground(Color.decode("#009999"));
        buttonPanel1.add(j);

        loadPanel.setBackground(Color.decode("#009999"));
        ...
        buttonPanel2.setBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY));
