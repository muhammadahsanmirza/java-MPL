        ...
        pre.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e
                ...
                if (selectedRow != -1) {
                    ...
                    // Check if the table has at least three columns (index 2 is valid)
                    if (table.getColumnCount() > 2) {
                        table.setValueAt("Present", selectedRow, 2);
                    } else {
                        // Show an error message via dialog box
                        showErrorDialog("Invalid column index (2) for the table.");
                    }
                } else {
                    // Show an error message via dialog box
...
// Method to show an error dialog box
        //-------------------------------------------------------
        //----------------------SUBMITBUTTON-----------------------
